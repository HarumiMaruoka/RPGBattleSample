...
namespace Skill
{
    ...
    {
        public SkillModel(int id, string name, string description,
        ...
        public static SkillModel CreateSkill(string[] strs)
        {
            ...
            return new SkillModel(id, name, description, category, weight, selectableTargetType, targetNum, targetingType, skillEffect);
        }
