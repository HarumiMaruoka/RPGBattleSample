    ...
    namespace Battle
    {
        public class BattleSystem
        {
            ...
            public void BattleStart()
            {
                ...
                {
                    // 戦闘用味方データを作成。
                    var allyModel = DataBase.GameDataBase.Instance.ActorDataBase.IDToActor[i];
                ...
                if (encounteredEnemyIDs != null && encounteredEnemyIDs.Count != 0)
                {
                    ...
                    {
                        // 戦闘用敵データを作成。
                        var enemyModel = DataBase.GameDataBase.Instance.ActorDataBase.IDToActor[encounteredEnemyIDs[i]];
                ...
                else // 遭遇した敵IDリストが存在しない場合。
                {
                    // ランダムに敵を抽選する。
                    {
                        ...
                        var randomActorModel = DataBase.GameDataBase.Instance.ActorDataBase.GetRandomActorModel();
